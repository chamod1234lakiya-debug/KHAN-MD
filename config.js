...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~KBVW3T6Z#-tnZLo2qOsgQy5k8U43Nmo6uiV65N1w9QJ4BTjRA98Q",  // Your bot's session ID (keep it secure)
    XDEV: process.env.XDEV || "",  // Github Username 
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    CHATBOT: getConfig("CHATBOT") || "off", // on/off chat bot 
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "C.L.P PROJECT",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "chamod lakshan",           // Owner's name
    DEV: process.env.DEV || "94777460336",                     // Developer's contact number
    DEVELOPER_NUMBER: '94777460336@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    STICKER_NAME: process.env.STICKER_NAME || "chmod lakshan md",     // Sticker pack name
